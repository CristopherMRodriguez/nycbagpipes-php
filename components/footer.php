<section class="footer-section">
  <footer class="footer">
    <div class="sitemap-footer footer-group">
      <a class="footer-group-ul" href="<?php echo "/";?>">Home</a>
      <ul class="hire-a-bagpiper-footer-ul footer-group-ul">
        <a href="<?php echo "/hire-a-bagpiper";?>"><h2>Hire a Bagpiper</h2></a>
      ...
      <ul class="learn-to-play-bagpipes-footer-ul footer-group-ul">
        <a href="<?php echo "/learn-to-play-the-bagpipes";?>"><h2>Learn to Play Bagpipes</h2></a>
      ...
      <ul class="nyc-bagpipes-faq-ul footer-group-ul">
        <a href="<?php echo "/bagpipe-faq";?>"><h2>NYC Bagpipes FAQ's</h2></a>
