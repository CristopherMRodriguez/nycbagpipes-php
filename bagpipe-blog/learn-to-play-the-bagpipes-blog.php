	...
	<body>
		...
		<section class="blog-post-section">
			<div class="blog-post-div">
				...
				<a target="_blank" href="https://rghardiestore.com/bagpipes/Practice-Chanters/PRC03P-Long-Plastic-Practice-Chanter">I own this bagpipe practice chanter, the R.G. Hardie Twist Trap</a>, and it does just fine.</a>  It is a “long” chanter, which quite simply means that it matches the length of an actual bagpipe chanter.  I would strongly suggest NOT to skimp out; buy a long one (instead of the regular. They also make junior sizes for children under 10).  These can last a lifetime since most are made from a strong plastic called polypenco. <a href="mailto: nycbagpipes@gmail.com">If you want to order one, email me</a> to find out where you can order from. You'll also save on the overseas shipping costs.</p>  
