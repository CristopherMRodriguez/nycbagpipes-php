<?php require "../components/head.php"?>
  ...
  <body>
		...
		<section class="section section-odd">
			<a class="pic-anchor"  class="button" href="https://www.nycbagpipes.com/learn-to-play-the-bagpipes/in-person-bagpipe-lessons">
				<img src="../img/bagpiper-soldier-2.jpg" alt="Learn Bagpipes In Person">
			</a>	
			<div class="section-div">
				<h1 class="section-title">Learn Bagpipes In Person</h1>
				<a class="landing-page-button-a" href="https://www.nycbagpipes.com/learn-to-play-the-bagpipes/in-person-bagpipe-lessons">					
					<button class="landing-page-button">	
						<h2 class="section-subtitle">In-Person Bagpipe Lessons Info</h2>
					</button>
				</a>  
				<p class="section-p">Get the benefits of face to face learning bagpipe instruction.  Learn more.</p>
			</div>
		</section>
		<div class="section-border"></div>
		<section class="section bottom-section section-even">
			<div class="section-div">
				...
				<a class="landing-page-button-a" href="https://www.nycbagpipes.com/learn-to-play-the-bagpipes/online-bagpipe-lessons">					
					<button class="landing-page-button">
			...
			<a class="pic-anchor"  class="button" href="https://www.nycbagpipes.com/learn-to-play-the-bagpipes/online-bagpipe-lessons";?>">
