  ...
  <body> 
		...
		<section class="section section-odd">
			<a class="pic-anchor" href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-funeral">
			...
			<div class="section-div">
				...
				<a class="landing-page-button-a"  href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-funeral">
					<button>	
		...
		<section class="section section-even">
			<div class="section-div">
				...
				<a class="landing-page-button-a"  href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-wedding-ceremony">
			...
			<a class="pic-anchor" href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-wedding-ceremony">
				<img src="../img/hire-a-bagpiper-at-wedding.jpg" alt="Bagpiper Playing at Wedding">
			</a>
		</section>
		<div class="section-border"></div>
		<section class="section section-odd">
			<a class="pic-anchor" href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-wedding-reception">
			...
			<div class="section-div">
				...
				<a class="landing-page-button-a"  href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-wedding-reception">
					<button class="landing-page-button">
						<h3 class="section-subtitle">Bagpiper for a Wedding Reception Info</h3>
					</button>
				</a>
		...
		<section class="section section-even">
			<div class="section-div">
				...
				<a class="landing-page-button-a"  href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-any-event">
					<button class="landing-page-button">
						<h3 class="section-subtitle">Bagpiper for Party or Any Event Info</h3>
					</button>
				</a>
				<p class="section-p">Got a party? Bagpipes will give it some extra fun!</p>
			</div>
			<a class="pic-anchor" href="https://www.nycbagpipes.com/hire-a-bagpiper/bagpiper-for-any-event">
