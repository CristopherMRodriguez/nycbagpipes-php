<?php require "../components/head.php"?>
		<title>Bagpipe Music Theory Beginner Exercises for Bagpipes</title>
		<?php $content = "Lesson 8 - Bagpipe Music Theory</a>";?>
		<meta name="description" content="<?php echo $content;?>">
    <link rel=“canonical” href=“https://www.nycbagpipes.com/exercises/lesson-8.php">
  ...
  <body>
      ...
      <div class="lesson-8">
        ...
        <ul class="lesson-8-ul">
          ...
          <li class="lesson-8-li"><a class="italic" href=https://www.youtube.com/watch?v=ZfrtRr5Mglk" target="blank">3/4 March</a></li>
          <li class="lesson-8-li"><a class="italic" href="https://www.youtube.com/watch?v=vBKBI7DOLHA" target="blank">4/4 March</a> (VERY common, especially in street bands from the U.S.A.)</li>
          <li class="lesson-8-li"><a class="italic" href="https://www.youtube.com/watch?v=amFMw4U59Ew" target="blank">6/4 March</a> (uncommon)</li>
        </ul>
        ...
        <p>Do you notice how there is a strong pulse that repeats (in every bar)? How often does that strong pulse repeat? every 2 beats (aka duple)? 3 (aka triple)? 4 (aka quadruple)? More?</p>
        <p>Other bagpipe idioms with the above time signatures:</p>
          <ul class="lesson-8-ul">
          <li class="lesson-8-li"><a class="italic" href="https://www.youtube.com/watch?v=JN-CtTRu7tw" target="blank">6/8 Jig</a> (unlike the 6/8 March; the subdivided pulses are usually divided equally into 3’s).</li>
          <li class="lesson-8-li"><a class="italic" href="https://www.youtube.com/watch?v=Qy0Db0R5Dao" target="blank">9/8 Jig</a> (similar to above but 3 pulses per bar).</li>
